...
const app: FastifyPluginAsync<AppOptions> = async (
  ...
  await fastify.register(fastifyEnv, {
    ...
    schema: S.object()
      ...
      .prop("GOOGLE_GENERATIVE_AI_API_KEY", S.string())
  ...
  if (isGeminiModel && !GOOGLE_GENERATIVE_AI_API_KEY) {
    fastify.log.error("Missing GOOGLE_GENERATIVE_AI_API_KEY for Gemini model", {
      model: AI_MODEL,
    });
    throw new Error(
      "GOOGLE_GENERATIVE_AI_API_KEY is required when using Gemini models",
    );
  }
